...
UniValue getaccountaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "\nDEPRECATED. Returns the current VIPSTARCOIN address for receiving payments to this account.\n"
            "\nArguments:\n"
            "1. \"account\"       (string, required) The account name for the address. It can also be set to the empty string \"\" to represent the default account. The account does not need to exist, it will be created and a new address created  if there is no account by the given name.\n"
            "\nResult:\n"
            "\"address\"          (string) The account VIPSTARCOIN address\n"
            "\nExamples:\n"
...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The VIPSTARCOIN address to be associated with an account.\n"
            "2. \"account\"         (string, required) The account to assign the address to.\n"
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\" \"tabby\"")
            + HelpExampleRpc("setaccount", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\", \"tabby\"")
        );
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The VIPSTARCOIN address for account lookup.\n"
            "\nResult:\n"
            "\"accountname\"        (string) the account address\n"
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\"")
            + HelpExampleRpc("getaccount", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\"")
        );
...
UniValue getaddressesbyaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "  \"address\"         (string) a VIPSTARCOIN address associated with the given account\n"
            "  ,...\n"
            "]\n"
            "\nExamples:\n"
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"            (string, required) The VIPSTARCOIN address to send to.\n"
            ...
            "                             The recipient will receive less VIPSTARCOIN than you enter in the amount field.\n"
            "\nResult:\n"
            "\"txid\"                  (string) The transaction id.\n"
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\" 0.1")
            + HelpExampleCli("sendtoaddress", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\" 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\" 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\", 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue createcontract(const JSONRPCRequest& request){
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 6)
        throw runtime_error(
                ...
                "3. gasPrice  (numeric or string, optional) gasPrice VIPS price per gas unit, default: "+FormatMoney(nGasPrice)+", min:"+FormatMoney(minGasPrice)+"\n"
				"4. \"senderaddress\" (string, optional) The VIPSTARCOIN address that will be used to create the contract.\n"
...
UniValue sendtocontract(const JSONRPCRequest& request){
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw runtime_error(
                ...
                "5. gasPrice  (numeric or string, optional) gasPrice VIPSTARCOIN price per gas unit, default: "+FormatMoney(nGasPrice)+", min:"+FormatMoney(minGasPrice)+"\n"
                "6. \"senderaddress\" (string, optional) The VIPSTARCOIN address that will be used as sender.\n"
                ...
                + HelpExampleCli("sendtocontract", "\"c6ca2697719d00446d4ea51f6fac8fd1e9310214\" \"54f6127f\" 12.0015 6000000 "+FormatMoney(minGasPrice)+" \"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\"")
        );
...
UniValue listaddressgroupings(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp)
        throw runtime_error(
            ...
            "  [\n"
            "    [\n"
            "      \"address\",            (string) The VIPSTARCOIN address\n"
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw runtime_error(
            ...
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            "1. \"address\"         (string, required) The VIPSTARCOIN address to use for the private key.\n"
            ...
            + HelpExampleCli("signmessage", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\" \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\" \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\", \"my message\"")
        );
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The VIPSTARCOIN address for transactions.\n"
            "2. minconf             (numeric, optional, default=1) Only include transactions confirmed at least this many times.\n"
            "\nResult:\n"
            "amount   (numeric) The total amount in " + CURRENCY_UNIT + " received at this address.\n"
            "\nExamples:\n"
            "\nThe amount from transactions with at least 1 confirmation\n"
            + HelpExampleCli("getreceivedbyaddress", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\"") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\" 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\" 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\", 6")
       );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 6)
        throw runtime_error(
            ...
            "\nDEPRECATED (use sendtoaddress). Sent an amount from an account to a VIPSTARCOIN address."
            + HelpRequiringPassphrase() + "\n"
            "\nArguments:\n"
            ...
            "                       the spend.\n"
            "2. \"toaddress\"         (string, required) The VIPSTARCOIN address to send funds to.\n"
            ...
            + HelpExampleCli("sendfrom", "\"\" \"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\" 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" \"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\" 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", \"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\", 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw runtime_error(
            ...
            "    {\n"
            "      \"address\":amount   (numeric or string) The VIPSTARCOIN address is the key, the numeric amount (can be string) in " + CURRENCY_UNIT + " is the value\n"
            "      ,...\n"
            "    }\n"
            ...
            "                           Those recipients will receive less VIPSTARCOIN than you enter in their corresponding amount field.\n"
            ...
            + HelpExampleCli("sendmany", "\"\" \"{\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\":0.01,\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\":0.01,\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\":0.01,\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\":0.02}\" 1 \"\" \"[\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\",\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"\", \"{\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\":0.01,\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\":0.02}\", 6, \"testing\"")
        );
    ...
    BOOST_FOREACH(const string& name_, keys)
    {
        ...
        if (!address.IsValid())
            throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid VIPSTARCOIN address: ")+name_);
...
UniValue sendmanywithdupes(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw runtime_error(
            ...
            "\nExamples:\n"
            "\nSend two amounts to two different addresses:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\":0.01,\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\":0.01,\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\":0.01,\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\":0.02}\" 1 \"\" \"[\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\",\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmanywithdupes", "\"\", \"{\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\":0.01,\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\":0.02}\", 6, \"testing\"")
        );
...
UniValue addmultisigaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 3)
    {
        string msg = "addmultisigaddress nrequired [\"key\",...] ( \"account\" )\n"
            ...
            "Each key is a VIPSTARCOIN address or hex-encoded public key.\n"
            "If 'account' is specified (DEPRECATED), assign address to that account.\n"

            "\nArguments:\n"
            "1. nrequired        (numeric, required) The number of required signatures out of the n keys or addresses.\n"
            "2. \"keys\"         (string, required) A json array of VIPSTARCOIN addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"address\"  (string) VIPSTARCOIN address or hex-encoded public key\n"
            "       ...,\n"
            "     ]\n"
            "3. \"account\"      (string, optional) DEPRECATED. An account to assign the addresses to.\n"

            "\nResult:\n"
            "\"address\"         (string) A VIPSTARCOIN address associated with the keys.\n"

            "\nExamples:\n"
            "\nAdd a multisig address from 2 addresses\n"
            + HelpExampleCli("addmultisigaddress", "2 \"[\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\",\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\"]\"") +
            "\nAs json rpc call\n"
            + HelpExampleRpc("addmultisigaddress", "2, \"[\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\",\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\"]\"")
        ;
...
UniValue listtransactions(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw runtime_error(
            ...
            "    \"address\":\"address\",    (string) The VIPSTARCOIN address of the transaction. Not present for \n"
...
UniValue listsinceblock(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp)
        throw runtime_error(
            ...
            "    \"address\":\"address\",    (string) The VIPSTARCOIN address of the transaction. Not present for move transactions (category = move).\n"
...
UniValue gettransaction(const JSONRPCRequest& request_)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 3)
        throw runtime_error(
            ...
            "      \"address\" : \"address\",          (string) The VIPSTARCOIN address involved in the transaction\n"
...
UniValue walletpassphrase(const JSONRPCRequest& request)
{
    ...
    if (pwalletMain->IsCrypted() && (request.fHelp || request.params.size() < 2 || request.params.size() > 3))
        throw runtime_error(
            ...
            "This is needed prior to performing transactions related to private keys such as sending VIPSTARCOIN\n"
            "\nArguments:\n"
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (pwalletMain->IsCrypted() && (request.fHelp || request.params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\" 1.0") +
...
UniValue encryptwallet(const JSONRPCRequest& request)
{
    ...
    if (!pwalletMain->IsCrypted() && (request.fHelp || request.params.size() != 1))
        throw runtime_error(
            ...
            "\nNow set the passphrase to use the wallet, such as for signing or sending VIPSTARCOIN\n"
    ...
    StartShutdown();
    return "wallet encrypted; VIPSTARCOIN server stopping, restart to run with encrypted wallet. The keypool has been flushed and a new HD seed was generated (if you are using HD). You need to make a new backup.";
}
...
UniValue lockunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
            ...
            "A locked transaction output will not be chosen by automatic coin selection, when spending VIPSTARCOIN.\n"
...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw runtime_error(
            ...
            "3. \"addresses\"    (string) A json array of VIPSTARCOIN addresses to filter\n"
            "    [\n"
            ...
            "    \"vout\" : n,               (numeric) the vout value\n"
            "    \"address\" : \"address\",    (string) the VIPSTARCOIN address\n"
            ...
            "\nExamples\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\",\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"VD5tffByCTgKtQssUxuSuykcsTV6PFULfE\\\",\\\"VYpgSAGYsSwmFukkWzugzqr3BragHnJRdA\\\"]\"")
        );
    ...
    if (request.params.size() > 2 && !request.params[2].isNull()) {
        ...
        for (unsigned int idx = 0; idx < inputs.size(); idx++) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_ADDRESS_OR_KEY, string("Invalid VIPSTARCOIN address: ")+input.get_str());
            if (setAddress.count(address))
...
UniValue fundrawtransaction(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
                            ...
                            "   {\n"
                            "     \"changeAddress\"          (string, optional, default pool address) The VIPSTARCOIN address to receive the change\n"
    ...
    if (request.params.size() > 1) {
      if (request.params[1].type() == UniValue::VBOOL) {
        ...
        if (options.exists("changeAddress")) {
            ...
            if (!address.IsValid())
                throw JSONRPCError(RPC_INVALID_PARAMETER, "changeAddress must be a valid VIPSTARCOIN address");
