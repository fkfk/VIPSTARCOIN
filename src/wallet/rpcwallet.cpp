...
UniValue setaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("setaccount", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD \"tabby\"")
            + HelpExampleRpc("setaccount", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD, \"tabby\"")
        );
...
UniValue getaccount(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("getaccount", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD")
            + HelpExampleRpc("getaccount", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD")
        );
...
UniValue sendtoaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw runtime_error(
            ...
            "\nExamples:\n"
            + HelpExampleCli("sendtoaddress", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD 0.1")
            + HelpExampleCli("sendtoaddress", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD 0.1 \"donation\" \"seans outpost\"")
            + HelpExampleCli("sendtoaddress", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD 0.1 \"\" \"\" true")
            + HelpExampleRpc("sendtoaddress", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD, 0.1, \"donation\", \"seans outpost\"")
        );
...
UniValue sendtocontract(const JSONRPCRequest& request){
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 8)
        throw runtime_error(
                ...
                + HelpExampleCli("sendtocontract", "\"c6ca2697719d00446d4ea51f6fac8fd1e9310214\" \"54f6127f\" 12.0015 6000000 "+FormatMoney(minGasPrice)+" VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD")
        );
...
UniValue signmessage(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 2)
        throw runtime_error(
            ...
            + HelpExampleCli("signmessage", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD \"my message\"") +
            "\nVerify the signature\n"
            + HelpExampleCli("verifymessage", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD \"signature\" \"my message\"") +
            "\nAs json rpc\n"
            + HelpExampleRpc("signmessage", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD, \"my message\"")
        );
...
UniValue getreceivedbyaddress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw runtime_error(
            ...
            + HelpExampleCli("getreceivedbyaddress", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD") +
            "\nThe amount including unconfirmed transactions, zero confirmations\n"
            + HelpExampleCli("getreceivedbyaddress", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD 0") +
            "\nThe amount with at least 6 confirmation, very safe\n"
            + HelpExampleCli("getreceivedbyaddress", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD 6") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("getreceivedbyaddress", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD, 6")
       );
...
UniValue sendfrom(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 3 || request.params.size() > 6)
        throw runtime_error(
            ...
            + HelpExampleCli("sendfrom", "\"\" VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD 0.01") +
            "\nSend 0.01 from the tabby account to the given address, funds must have at least 6 confirmations\n"
            + HelpExampleCli("sendfrom", "\"tabby\" VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD 0.01 6 \"donation\" \"seans outpost\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendfrom", "\"tabby\", VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD, 0.01, 6, \"donation\", \"seans outpost\"")
        );
...
UniValue sendmany(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw runtime_error(
            ...
            + HelpExampleCli("sendmany", "\"\" \"{\\\"SP4mobbMXnitGzi8rKq8PpuAFWVKrspBsZ\\\":0.01,\\\"SGWSdcG52ofSsX1tbf2zqdob2ZQ2rRh55o\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"SP4mobbMXnitGzi8rKq8PpuAFWVKrspBsZ\\\":0.01,\\\"SGWSdcG52ofSsX1tbf2zqdob2ZQ2rRh55o\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmany", "\"\" \"{\\\"SP4mobbMXnitGzi8rKq8PpuAFWVKrspBsZ\\\":0.01,\\\"SGWSdcG52ofSsX1tbf2zqdob2ZQ2rRh55o\\\":0.02}\" 1 \"\" \"[\\\"SP4mobbMXnitGzi8rKq8PpuAFWVKrspBsZ\\\",\\\"SGWSdcG52ofSsX1tbf2zqdob2ZQ2rRh55o\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmany", "\"\", \"{\\\"SP4mobbMXnitGzi8rKq8PpuAFWVKrspBsZ\\\":0.01,\\\"SGWSdcG52ofSsX1tbf2zqdob2ZQ2rRh55o\\\":0.02}\", 6, \"testing\"")
        );
...
UniValue sendmanywithdupes(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 2 || request.params.size() > 5)
        throw runtime_error(
            ...
            "\nExamples:\n"
            "\nSend two amounts to two different addresses:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"SP4mobbMXnitGzi8rKq8PpuAFWVKrspBsZ\\\":0.01,\\\"SGWSdcG52ofSsX1tbf2zqdob2ZQ2rRh55o\\\":0.02}\"") +
            "\nSend two amounts to two different addresses setting the confirmation and comment:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"SP4mobbMXnitGzi8rKq8PpuAFWVKrspBsZ\\\":0.01,\\\"SGWSdcG52ofSsX1tbf2zqdob2ZQ2rRh55o\\\":0.02}\" 6 \"testing\"") +
            "\nSend two amounts to two different addresses, subtract fee from amount:\n"
            + HelpExampleCli("sendmanywithdupes", "\"\" \"{\\\"SP4mobbMXnitGzi8rKq8PpuAFWVKrspBsZ\\\":0.01,\\\"SGWSdcG52ofSsX1tbf2zqdob2ZQ2rRh55o\\\":0.02}\" 1 \"\" \"[\\\"SP4mobbMXnitGzi8rKq8PpuAFWVKrspBsZ\\\",\\\"SGWSdcG52ofSsX1tbf2zqdob2ZQ2rRh55o\\\"]\"") +
            "\nAs a json rpc call\n"
            + HelpExampleRpc("sendmanywithdupes", "\"\", \"{\\\"SP4mobbMXnitGzi8rKq8PpuAFWVKrspBsZ\\\":0.01,\\\"SGWSdcG52ofSsX1tbf2zqdob2ZQ2rRh55o\\\":0.02}\", 6, \"testing\"")
        );
...
UniValue walletlock(const JSONRPCRequest& request)
{
    ...
    if (pwalletMain->IsCrypted() && (request.fHelp || request.params.size() != 0))
        throw runtime_error(
            ...
            + HelpExampleCli("sendtoaddress", "VWTeUyCZsePENeFSMz7ydfY9HNevKiCChD 1.0") +
...
UniValue listunspent(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() > 4)
        throw runtime_error(
            ...
            "\nExamples\n"
            + HelpExampleCli("listunspent", "")
            + HelpExampleCli("listunspent", "6 9999999 \"[\\\"SFQ2V1dBALfnT8HcRxnZ1cBWwwYhFeLSm6\\\",\\\"S9pg7ZANHE9hCZgHaDiPF8Pi7ipsLB9LGM\\\"]\"")
            + HelpExampleRpc("listunspent", "6, 9999999 \"[\\\"SFQ2V1dBALfnT8HcRxnZ1cBWwwYhFeLSm6\\\",\\\"S9pg7ZANHE9hCZgHaDiPF8Pi7ipsLB9LGM\\\"]\"")
        );
